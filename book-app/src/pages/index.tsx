    ...
    <header className={styles.hero}>
      <div className={styles.heroInner}>
        ...
        <div className={styles.heroButtons}>
          ...
          <Link className={styles.secondaryButton} to="https://github.com/HasnainCodeHub/Hackathon-1-Robotics-book">
            View on GitHub
          </Link>
        </div>
    ...
    <section className={styles.ctaSection}>
      <div className={styles.container}>
        ...
        <div className={styles.ctaButtons}>
          ...
          <Link className={styles.outlineButton} to="https://github.com/HasnainCodeHub/Hackathon-1-Robotics-book">
            GitHub Repository
          </Link>
        </div>
      </div>
      ...
      <div className={styles.container}>
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerColumn}>
            <h4>Resources</h4>
            <ul>
              <li><Link to="https://github.com/HasnainCodeHub/Hackathon-1-Robotics-book">GitHub Repository</Link></li>
              <li><Link to="https://github.com/panaversity">Panaversity</Link></li>
              <li><Link to="https://github.com/HasnainCodeHub">Author's GitHub</Link></li>
            </ul>
          </div>
          <div className={styles.footerColumn}>
            <h4>Technologies</h4>
